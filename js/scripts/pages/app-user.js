...
$(document).ready(function () {
  ...
  var customIconsHTML = function (params) {
    ...
    //return usersIcons
    return "<a href='/dashboard/user-edit/"+params.data.id+"'><i class='users-edit-icon feather icon-edit-1 mr-50'></i></a><a href='/dashboard/user-view/"+params.data.id+"'><i class='users-edit-icon feather icon-zoom-out mr-50'></i></a>"
  ...
  if (document.getElementById("myGrid")) {
    ...
    agGrid
      .simpleHttpRequest({
        url: "http://127.0.0.1:8000/dashboard/user/json.json"
      })
      .then(function (data) {
    ...
    $(".users-data-filter").click(function () {
      ...
      $('#users-list-gender').prop('selectedIndex', 0);
      $('#users-list-gender').change();

      $('#users-list-khEmployee').prop('selectedIndex', 0);
      $('#users-list-khEmployee').change();

      $('#users-list-isBlocked').prop('selectedIndex', 0);
      $('#users-list-isBlocked').change();

      $('#users-list-department').prop('selectedIndex', 0);
      $('#users-list-department').change();

      $('#users-list-location').prop('selectedIndex', 0);
      $('#users-list-location').change();
    });
